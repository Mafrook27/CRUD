...
import withDataFetch from '../utils/Datafetch';


const MainData = ({ fetchedData = [], isLoading, error }) => {
...
export default withDataFetch(MainData, 'https://fakerapi.it/api/v1/users');